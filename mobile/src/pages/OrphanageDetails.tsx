...
import { Image, Linking, View, ScrollView, Text, StyleSheet, Dimensions, TouchableOpacity } from 'react-native';
...
interface OphanageDetailsRoutePrams {
  id: number
}
...
export default function OrphanageDetails() {
  ...
  const params = route.params as OphanageDetailsRoutePrams;
